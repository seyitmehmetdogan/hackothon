...
const products = [
  ...
  },
  {
    ...
    imageAlt: "Apple AirPods Max over-ear headphones with premium aluminum design",
    features: ["ANC", "Spatial Audio", "20h Pil"],
    accentColor: "#a3a3a3",
  ...
  },
  {
    ...
    imageAlt: "Apple AirPods Pro 2 wireless earbuds with charging case",
    features: ["ANC 2x", "Adaptive Audio", "6h Pil"],
    accentColor: "#1d1d1f",
    accentBg: "rgba(29,29,31,0.06)",
  },
  {
    id: "jbl-tune-770nc",
    name: "JBL Tune 770NC",
    ...
    imageAlt: "JBL Tune 770NC over-ear wireless headphones with noise cancelling",
    features: ["ANC", "Pure Bass", "70h Pil"],
    accentColor: "#ff6600",
  ...
  },
  {
    ...
    imageAlt: "JBL Live Pro 2 true wireless earbuds with charging case",
    features: ["ANC", "JBL Signature", "40h Pil"],
    accentColor: "#ff6600",
    accentBg: "rgba(255,102,0,0.08)",
  },
  {
  ...
  },
  {
    ...
    name: "Xiaomi Scooter 4 Pro",
    tagline: "Elektrikli Scooter",
    category: "scooter",
    price: 18999,
    originalPrice: 22999,
    rating: 4.9,
    ...
    imageAlt: "Xiaomi Electric Scooter 4 Pro on urban street, modern design",
    features: ["55km Menzil", "25km/h Hız", "Katlanabilir"],
    accentColor: "#ff6900",
    accentBg: "rgba(255,105,0,0.08)",
  },
  {
    ...
    reviews: 2187,
    badge: "Premium",
    image: "https://images.unsplash.com/photo-1604868189265-219ba7ffc595",
    imageAlt: "Segway Ninebot Max G2 electric scooter, professional grade",
    features: ["70km Menzil", "30km/h Hız", "IPX7"],
    accentColor: "#e60012",
  ...
  },
  {
    ...
    imageAlt: "Razor E Prime III electric scooter, lightweight and portable",
    features: ["24km Menzil", "24km/h Hız", "Hafif"],
    accentColor: "#00a0e3",
    accentBg: "rgba(0,160,227,0.08)",
  },
  {
    id: "pure-air-pro-lg",
    name: "Pure Air Pro LG",
    tagline: "Elektrikli Scooter",
    category: "scooter",
    price: 15999,
    originalPrice: 19999,
    ...
    reviews: 1876,
    badge: "Popüler",
    image: "https://images.unsplash.com/photo-1659011898058-10e9810e6049",
    imageAlt: "Pure Air Pro LG electric scooter with long range battery",
    features: ["50km Menzil", "25km/h Hız", "LG Batarya"],
    accentColor: "#1a1a1a",
    accentBg: "rgba(26,26,26,0.08)",
  },
  {
    id: "hoverboard",
    name: "Hoverboard",
